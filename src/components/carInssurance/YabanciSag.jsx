...
import kaskoImage from "../../assets/producthero/yabancılar-saglik-sigortasi.svg";
...
import YabanciHero from "../KategoriPage/YabnaciHero";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">Yabancılara Sağlık Sigortası Nedir?</h2>

        Türkiye’ye gelen yabancı uyruklu şahısların uzun süreli ikamet tezkeresi ve oturma izni alabilmeleri amacı ile gerekli olan bu sağlık sigortasıdır. Kapsamı sigortayı yaptıranın seçimine göredir. Yabancı uyruklu şahısların bahsedilen teminat dahilinde, meydana gelebilecek herhangi bir hastalık ve benzeri ya da kaza durumlarında, yabancı uyruklu şahısların sağlık masraflarını karşılayan bir sigorta anlamına gelmektedir. Yabancılar için sağlık sigortası hem acil hem de rutin sağlık hizmetleri için oluşturulmuş tedavileri kapsamaktadır. 
    ...
    <article className="article group">
      ...
      />
      <section className="content">
        <h2 className="headline">Yabancılara Sağlık Sigortası Fiyatları Nasıl Hesaplanır? </h2>
        
        Hesaplama; yaşınız, cinsiyetiniz ve sigorta kapsamıyla değişiklik gösterecektir. Sigorta şirketlerinden sizin için oluşturulan fiyatlar poliçe kapsamını için hemen irtibata geçebilirsiniz. 
          ...
          <article className="article group">
            <section className="content nasilAl" style={{marginTop:"0"}} >
              <h2 className="headline">
               Yabancılara Sağlık Sigortası Teklifi Nasıl Alınır ?
              </h2>
