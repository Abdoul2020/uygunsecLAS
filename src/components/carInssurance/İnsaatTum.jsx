...
import İnsaatHero from "../KategoriPage/İnsaatHero"
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">İnşaat Tüm Riskler Sigortası</h2>
        İnşaat sürecindeki tüm risklerinize karşı koruma sağlamak için İnşaat Tüm Riskler Sigortası’nı geliştirdik. Böylelikle biz, inşaat faaliyetlerinin her aşamasında oluşabilecek beklenmedik zararlara karşı sizi ve projenizi korurken, siz de gönül rahatlığıyla projenize odaklanabilirsiniz.Herhangi bir soru işaretiniz olması durumunda, iletişime geçerek daha detaylı bilgi alabilirsiniz.
        ...
        <div>
          <article className="article group">
            <section className="content nasilAl"  style={{marginTop:"0"}}>
              ...
              İnşaat Tüm Riskler Sigortası Teklifi Nasıl Alınır ?
              </h2>
