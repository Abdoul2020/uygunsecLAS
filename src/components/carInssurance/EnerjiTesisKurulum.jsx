...
import EnerjiTesisHero from "../KategoriPage/EnerjiTesisHero";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">GES- ÇATI GES , HES- RES –BIO GAZ, ENERJİ SANTRALLERİ, birden çok kaynaklı elektrik üretim, Üretim tesisine bütünleşik elektrik depolama, Araç Şarj istasyonları vb. projelerin sigortalanması.
        </h2>


        Enerji Santrallerinde Sigorta kritik önem arz etmektedir. Matbu sigortacılık anlayışının dışında her kurulacak tesis için tesisin kendine has özellikler /riskler ihtiva edecek teminatlar oluşturulmalıdır. Uzman kadromuz ile kurulacak tesise ait riskler doğru analiz edilmekte, projeye “proje özelinde “ teminat oluşturulabilmekte. İşletme dönemine ait riskleri sahada tespit edip oluşturulan risk analizi doğrultusunda iş özelinde hazırlanan wordingler ile teminatlandırmaktayız.
...
<br /><br /><br />
        <p>
          <em>
          Enerji özelinde detaylı bilgi için bizle iletişime geçebilirsiniz.
          </em>
        </p>
          ...
          <article className="article group">
            <section className="content nasilAl"  style={{marginTop:"0"}}>
              <h2 className="headline">
                Enerji Kurulumu & İşletim Sigortası Teklifi Nasıl Alınır ?
              </h2>
...
export default EnerjiTesisiKurlum;
