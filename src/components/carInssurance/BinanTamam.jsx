...
import kaskoImage from "../../assets/producthero/bina-tamamlama-sigortasi.svg";
...
import BinaHero from "../KategoriPage/BinaHero"
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">Bina Tamamlama Sigortası Nedir?</h2>
        Bina Tamamlama Sigortası, bir Kefalet Sigorta Branşı ürünü ve Kefalet Sigortası türüdür. Bu sigorta sözleşmesi ile sigortacı;6502 sayılı Tüketicinin Korunması Hakkında Kanun kapsamındaki ön ödemeli konut veya devre tatil satışlarında,  Satıcının Sözleşmede taahhüt edilen süreyi takip eden 12 aylık sürede konutun tamamlanmaması durumunda Bina Tamamlama Sigortası, hem inşaat firmalarını hem konut sahibi olacakları koruyan bir sigorta ürünüdür.
    ...
    <article className="article group">
      ...
      />
      <section className="content">
        <h2 className="headline">Bina Tamamlama Sigortası Sigortası Fiyatları Nasıl Hesaplanır?</h2>
          ...
          <article className="article group">
            <section className="content nasilAl"  style={{marginTop:"0"}} >
              <h2 className="headline">
               ...
               Bina Tamamlama Sigortası Teklifi Nasıl Alınır?
