...
import kaskoImage from "../../assets/producthero/vize-ve-seyehat-sigortasi.svg";
...
import SeyahatHero from "../KategoriPage/SeyahatHero";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">Vize ve Seyahat Sigortası Nedir?</h2>
        Yurtdışına yapılan süreli seyahatlerde vize gereksin gerekmesin sigorta yaptırmak ülkeye girişte sorunla karşılaşmanızı engelleyecektir. Birçok ülke vize sürecinde seyahat süresini kapsayan sigortayı istemektedir. Yapılacak sigorta ile seyahat ettiğiniz ülkeden oluşacak kaza ya da ani rahatsızlanma durumda tedavi masraflarını karşılarken aynı zamanda sağlık ve cenaze nakli masraflarını da öder. Sağlık sorunu yaşadığında tedavin bitip taburcu olduktan sonra evine dönme masrafın da seyahat sigortan kapsamında olur.
    ...
    <article className="article group">
      ...
      />
      <section className="content">
        <h2 className="headline">Vize ve Seyahat Sigortası Fiyatları Nasıl Hesaplanır? </h2>
        Hesaplama; yaşınız, seyahat edilecek ülke ve seyahat süresine göre yapılır. Sigorta şirketlerinden sizin için oluşturulan fiyatlar poliçe kapsamını için hemen irtibata geçebilirsiniz. 
          ...
          <article className="article group">
            <section className="content nasilAl" style={{marginTop:"0"}}>
              <h2 className="headline">
                Vize ve Seyahat Sigortası Teklifi Nasıl Alınır ?
              </h2>
