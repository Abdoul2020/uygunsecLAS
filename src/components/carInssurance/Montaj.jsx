...
import MontajHero from "../KategoriPage/MontajHero";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">Montaj Tüm Riskler</h2>
        Montaj sırasında yapılan yanlış bir işlem işlerinizin aksamasına neden olabilir. Bu aksaklık sadece ekipmanlarınıza zarar vermekle kalmaz beklenmedik mali kayıplara da sebep olabilir.
Bu gibi durumlara karşı hazırlıklı olmak için Montaj Tüm Riskler Sigortası (EAR) yaptırın, işletmenizin geleceğini, ani ve beklenmedik risklere karşı, tek bir ürünle koruma altına alın. Detaylı bilgi alabilirsiniz 
          ...
          <article className="article group">
            <section className="content nasilAl"  style={{marginTop:"0"}}>
              <h2 className="headline">
                Montaj Riskler Sigortası Teklifi Nasıl Alınır ?
              </h2>
