...
import kaskoImage from "../../assets/producthero/trafik-sigortasi.svg"
...
import TrafikMostAsk from '../TrafikMostAsk';
...
import TrafikHero from "../KategoriPage/TrafikHero"

import answer from "../../assets/producthero/productHeroNew/trafikNedir.svg";
import price from "../../assets/producthero/productHeroNew/trafik-Nasil-hesaplanir.svg";
...
<h2 className="headline" >Trafik Sigortası Nedir?</h2>
...
marginRight:"20px"}} />
<section className="content" >
<h2 className="headline">Trafik Sigortası Fiyatları Nasıl Hesaplanır?</h2>
...
<h2 className="headline">Trafik Sigortası Teklifi Nasıl Alınır ?</h2>
...
<Grid item xs={12} sm={12} md={12} lg={12} className="" style={{marginTop:"50px"}}>

<TrafikMostAsk data={questions}/>
</Grid>
...
<div className='partnershipDiv'>
  ...
  <div  className='text-2xl font-bold text-center pt-20 pb-9'>
    <h1>
    Anlaşmalı Trafik Sigorta Şirketleri
    </h1>
  </div>
