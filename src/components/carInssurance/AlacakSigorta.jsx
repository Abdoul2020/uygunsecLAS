...
import kaskoImage from "../../assets/producthero/alacak-sigortasi.svg";
...
import AlacakHero from "../KategoriPage/AlacakHero";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">Devlet Destekli Alacak Sigortasi Nedir?</h2>
        Devlet Destekli Alacak Sigortası modeli KOBİ'lerin alacaklarını garanti altına alır. Bu sigorta sayesinde KOBİ'lerin alacaklarını tahsil edememeleri durumunda, Devlet Destekli Alacak Sigortası kapsamında karşılanmakta  Bu ürün firmanızın Ticari borçların ödenmeme riskine karşı korurken Ticari faaliyetlerinizde riskleri en güvenilir şekilde yönetmenizi sağlar. Vadeli satış sonrasında belirlenen tarihte ödenmeyen alacakların firmaları sıkıntıya sokmasını ve nakit akışlarını bozmasını önler. Nakit akışının sağlıklı olması ve firmaların taahhütlerini rahatça yerine getirmesini sağlar. Firmaların ileriye dönük mali planlarında aksamaları ortadan kaldırır.
    ...
    <article className="article group">
      ...
      />
      <section className="content">
        <h2 className="headline">Alacak Sigortası Fiyatları Nasıl Hesaplanır?</h2>
          ...
          <article className="article group">
            <section className="content nasilAl"  style={{marginTop:"0"}}>
              <h2 className="headline">
                Alacak Sigortası Teklifi Nasıl Alınır ?
              </h2>
