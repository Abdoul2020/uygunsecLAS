...
import kaskoImage from "../../assets/producthero/police-prim-kredisi.svg"
...
import PoliceHero from '../KategoriPage/PoliceHero';
...
<h2 className="headline" > Poliçe Prim Kredisi Nedir?</h2>
Finansal sigortalar konusundaki uzmanlığımız ile ezber bozan çalışmalarımıza bir yenisini daha ekledik! Amacımız; projelerimizi oluştururken Finans’ın gücünüzün size kalması,  poliçe primlerini  Finans Poliçe Prim Kredisi ile 12 aya kadar taksitlendirebilirsiniz detaylı bilgi ve talep için bizle iletişime geçebilirisniz. 
...
marginRight:"20px"}} />
<section className="content" >
<h2 className="headline"> Poliçe Prim Kredi Fiyatları Nasıl Hesaplanır?</h2>
