...
import kaskoImage from "../../assets/producthero/tamamlayici-saglik-sigortasi.svg";
...
import TamamSagHero from "../KategoriPage/TamamSagHero";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">Tamamlayıcı Sağlık Sigortası Nedir?</h2>
        
         Sigorta poliçenizin teminatları çerçevesinde anlaşmalı özel sağlık kurumlarında, özel şartlar kapsamında SGK tarafından karşılanan sağlık giderlerinizde oluşan fark ücretlerini hiçbir ek ödeme yapmadan karşılanmasıdır( SGK zorunlu muayene katılım payı hariç).
    ...
    <article className="article group">
      ...
      />
      <section className="content">
        <h2 className="headline">Tamamlayıcı Sağlık Sigortası Fiyatları Nasıl Hesaplanır?</h2>
        
        Hesaplama; yaşınız, cinsiyetiniz ve yaşadığınız şehre göre yapılır. Sigortanıza ait nihai prim miktarına ancak TC kimlik numaranız ile ulaşılabilir.  Sigorta şirketlerinden sizin için oluşturulan fiyatlar poliçe kapsamına ve ihtiyacınıza göre değişiklik gösterebilir, liste fiyatları ve kapsam üzerinden karşılaştırma yapmanız doğru olacaktır. 
  ...
  <div>
    ...
    >
      <div className="text-2xl font-bold text-center pt-20 pb-9">
        <h1> Tamamlayıcı Sağlık Sigortası Fiyatları</h1>
      </div>
      <table class="rwd-table">
        <tbody>
          <tr>
            ...
            <th>Model</th>
            <th>
              Araç Kasko Değeri (Ortalama Kasko <br /> Araç Değeri)
            </th>
            <th>Kasko Fiyatı</th>
            <th>Hasarsızlık İndirimi</th>
          </tr>
          <tr>
            <td data-th="Supplier Code" className="text-center">
              TOYOTA
            </td>
            <td data-th="Supplier Name" className="text-center">
              2020
            </td>
            <td data-th="Invoice Number" className="text-center">
              570.455 TL
            </td>
            <td data-th="Invoice Date" className="text-center">
              6.186 TL
            </td>
            <td data-th="Due Date" className="text-center">
              %40
            </td>
            <td data-th="Net Amount" className="text-center">
              $8,322.12
            </td>
          </tr>
          <tr>
