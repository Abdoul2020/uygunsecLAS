...
import DaskHero from "../KategoriPage/DaskHero";

import answer from "../../assets/producthero/productHeroNew/02-deprem-sigortasi-nedir.svg";
import price from "../../assets/producthero/productHeroNew/03-deprem-sigortasi-nasil-hesaplanir.svg";
  ...
  <div>
    <article className="article group">
      ...
      <section className="content">
        <h2 className="headline">DASK Sigortası Nedir?</h2>
        Zorunlu Deprem Sigortası (DASK) konutlarda depremin neden olacağı maddi zararların ödenmesini sağlayan sigorta türüdür. Ülkemiz riskli deprem bölgesindedir. Bu nedenle DASK, devletimiz tarafından yapılan kanuni düzenleme ile konutlar için zorunlu hale getirilmiştir.DASK'ın açılımı ise Doğal Afetler Sigortaları Kurumu'dur. Bu sigorta ile deprem sonrasında insanların maddi zorluklarını en aza indirmek hedeflenir.
    ...
    <article className="article group">
      ...
      />
      <section className="content">
        <h2 className="headline">Dask Sigortası Fiyatları Nasıl Hesaplanır?</h2>


        Hesaplama; taşınmazın bulunduğu şehir, alansal olarak büyüklük, semt vb. değişkenlere göre hesaplanmaktadır. Sigorta şirketlerinden sizin için oluşturulan fiyatlar ve poliçe kapsamı için hemen irtibata geçebilirsiniz.
          ...
          <article className="article group">
            <section className="content nasilAl"  style={{marginTop:"0"}}>
              <h2 className="headline">
                Dask Sigortası Teklifi Nasıl Alınır ?
              </h2>
