   ...
   <Grid container  className='heroHead'>
    ...
    <div className='text-black'>
      <div className='max-w-[800px]  w-full h-screen  flex flex-col justify-center'>
        ...
        İhtiyaçlarınız dinliyoruz , tamamlayıcı Sağlık sigortası ile sigortanızı tamamlıyoruz
Farka Takılma Rahatlığa Takıl!!!
Özel hastanelerde fark yok
