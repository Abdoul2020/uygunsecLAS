...
import asset2 from "../../assets/kampaya/Asset 5.jpg";
...
const TrafikHizmet = () => {
  ...
  return (
    ...
    <div className='kampaya-hear-title' style={{fontSize:"12px",lineHeight:"17px", letterSpacing: "-.01em" , cursor:"pointer", color:"#0e2e50"}}>
                    <h3>UygunuSec / Kampanyalar / Trafik sigortasında çekici hizmet</h3>
                </div>

                <div className='text-2xl font-bold  pt-10 text-[#0e2e50] kampayaTitle'>
                    <h1>
                    Trafik sigortasında çekici hizmet
                    </h1>
                </div>
...
<p>
Trafik sigortasında çekici hizmeti UygunuSEÇ de devam ediyor
</p>
...
<div>
    ...
    <ul>
        ...
        <li>
        • 1 Defa lastik Patlaması veya Yakıt Bitmesi ( En Yakın  Servise )
        </li>

        <li>
        • Olay Başı Limit: 1250 TL
        </li>

        <li>

        • Toplam Limit: 2500 TL <br />
(En yakın servise kadar tek seferde toplam limit kullanılabilir )
      ...
      <Grid container>
        ...
        <Grid item xs={12} sm={12} md={12} lg={12}>
          ...
          <ul className='kampanyaSideBar'>
            ...
            <li style={{ background: "#f2f7fd", borderRadius:"15px"}}> Trafik sigortasında çekici hizmeti UygunuSEÇ de devam ediyor. </li>
            </Link>
            ...
            <li>Kadın Sigortalılarımıza Uygunu Seç Hediye Paketti</li>
            </Link>
