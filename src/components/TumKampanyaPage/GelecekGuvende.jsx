...
import asset2 from "../../assets/kampaya/Asset 3.jpg";
...
const GelecekGuvende = () => {
  ...
  return (
    ...
    <div className='kampaya-hear-title' style={{fontSize:"12px",lineHeight:"17px", letterSpacing: "-.01em" , cursor:"pointer", color:"#0e2e50"}}>
                    <h3>UygunuSec / Kampanyalar / Geleceğiniz Uygunuseç ile Güvende</h3>
                </div>

                <div className='text-2xl font-bold  pt-10 text-[#0e2e50] kampayaTitle'>
                    <h1>
                    Geleceğiniz Uygunuseç ile Güvende
                    </h1>
                </div>
...
<p>
Kasko Poliçesi Yaptıran, 18—60 Yaş aralığı da geçerli olmak üzere, Ferdi Kaza Sigortanız Hediye Kaza sonucu vefat ve kaza sonucu daimi maluliyet durumlarına karşı kendiniz güvene alın.
</p>
      ...
      <Grid container>
        ...
        <Grid item xs={12} sm={12} md={12} lg={12}>
          ...
          <ul className='kampanyaSideBar'>
            ...
            <li  style={{ background: "#f2f7fd", borderRadius:"15px"}}>“Geleceğiniz Uygunu SEÇ ile Güvende”</li>
            </Link>
