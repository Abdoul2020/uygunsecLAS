...
import asset2 from "../../assets/kampaya/Asset 4.jpg";
...
const KaskoPpolice = () => {
  ...
  return (
    ...
    <div className='kampaya-hear-title' style={{fontSize:"12px",lineHeight:"17px", letterSpacing: "-.01em" , cursor:"pointer", color:"#0e2e50"}}>
                    <h3>UygunuSec / Kampanyalar / Kasko ve Trafik Poliçeleri</h3>
                </div>
...
<p>
Kasko ve Trafik Poliçelerini İLK kez Uygunu SEÇ i tercih edenlere:
</p>
...
<div>
    ...
    <ul>
        <li>
        •	Çekici kampanyamıza ilaveten,
        </li>
        <li>
        •	İlk yıla özel %5 lik bir hediye çeki (CarrefourSA ..Migros..)  
        </li>
        <li>
        •	Bir sonraki yıla ait kampanyamızda kullanılmak üzere %2,5 ilave  YENILEME indirimi
        </li>
    </ul>
...
<li style={{ background: "#f2f7fd", borderRadius:"15px"}}> Kasko ve Trafik Poliçelerini İLK kez Uygunu SEÇ i tercih edenlere; </li>
</Link>
