...
const KonutTasit = () => {
  ...
  return (
    ...
    <div className='kampaya-hear-title' style={{fontSize:"12px",lineHeight:"17px", letterSpacing: "-.01em" , cursor:"pointer", color:"#0e2e50"}}>
                    <h3>UygunuSec / Kampanyalar / Konut & Taşıt İhtiyacına Kredi Desteği</h3>
                </div>

                <div className='text-2xl font-bold  pt-10 text-[#0e2e50] kampayaTitle'>
                    <h1>
                    Konut & Taşıt İhtiyacına, Yönelik finansman Kredi Desteği.
                    </h1>
                </div>
      ...
      <Grid container>
        ...
        <Grid item xs={12} sm={12} md={12} lg={12}>
          ...
          <ul className='kampanyaSideBar'>
            ...
            <li style={{ background: "#f2f7fd", borderRadius:"15px"}}>Konut ve Taşıt ihtiyacına yönelik finansman kredisi desteği.</li>
            </Link>
